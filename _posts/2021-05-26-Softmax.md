...
Using Kroneker delta to simplify last expression
...
We get final formula for Softmax derivative
...
Gradient backpropagation to Softmax is dot product of input gradient and Softmax Jacobian J:

$$
\frac {\partial E} {\partial x} = \frac {2 * (Y - \hat {Y})} {N} * J
$$
