...
$$ J = \left( \begin{array}{ccc}
\frac {\sigma_{1}  *  ({1 - \sigma_{1}}) & -\sigma_{1} * sigma_{2} & \ldots & - \sigma_{1} * sigma_{M} \\
\frac {-\sigma_{2} * sigma_{1} & \sigma_{2}  *  ({1 - \sigma_{2}}) & \ldots & - \sigma_{2} * sigma_{M} \\
\vdots & \vdots & \ldots & \vdots \\
\frac {-\sigma_{M} * sigma_{1} & -\sigma_{M} * \sigma_{2} & \ldots & - \sigma_{M} (1 - sigma_{M}) \\
\end{array} \right)
$$
