...
$$
\frac {\partial E (\partial b) } {\partial X} = \frac {\partial E} {\partial \hat Y} \frac {\partial \hat Y} {\partial b}
$$
...
$$ \partial b $$ = \frac {\partial E} {\partial \hat Y} \left( \begin{array}{ccc}
1 \\
1 \\
\ldots
1
\end{array} \right) = \sum \frac {\partial E} {\partial \hat Y}
