...
1D convolution operator can be represented as a matrix multiplication of [Toeplitz matrix] [toeplitz_matrix] of convolution kernel weights and transposed input X:
...
\vdots  &  w_{2}  &  \ldots &   \vdots  &      0  \\
 w_{m}  & \vdots  &  \ldots &        0  & \vdots  \\
     0  &  w_{m}  &  \ldots &    w_{1}  &      0  \\
     0  &      0  &  \ldots &    w_{2}  &  w_{1}  \\
\end{array} \right) * \left( \begin{array}{ccc} x_{1} \\ x_{2} \\ \ldots \\ x_{n} \right)
$$
