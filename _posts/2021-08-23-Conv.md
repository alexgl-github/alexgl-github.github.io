...
\hat Y = T_{w} X^\intercal = \left( \begin{array}{ccc}
 w_{1}  &      0  &  \ldots &        0   \\
 w_{2}  &  w_{1}  &  \ldots &   \vdots   \\
\vdots  &  w_{2}  &  \ldots &    w_{1}   \\
 w_{m}  & \vdots  &  \ldots &   \vdots   \\
     0  &  w_{m}  &  \ldots &  w_{m-1}   \\
     0  &      0  &  \ldots &    w_{m}   \\
...
x_{1}  &      0  &  \ldots &        0   \\
x_{2}  &  x_{1}  &  \ldots &        0   \\
\vdots &  x_{2}  &  \ldots &    x_{1}   \\
x_{n}  & \ldots  &  \ldots &   \ldots   \\
   0   &  x_{n}  &  \ldots &  x_{n-1}   \\
   0   &      0  &  \ldots &    x_{n}   \\
\end{array} \right)
$$
...
\frac {\partial E (\hat Y) } {\partial X} = J T_{w}^\intercal = \left( \frac {\partial E} {\partial \hat y_{1}}, \frac {\partial E} {\partial \hat y_{2}},  \ldots, \frac {\partial E} {\partial \hat y_{n} } \right)  \left( \begin{array}{ccc}
 w_{1}  &  w_{2}  &  \ldots &    w_{m}  &       0  &       0  \\
     0  &  w_{1}  &   w_{2} &   \ldots  &   w_{m}  &       0  \\
\ldots  & \ldots  &  \ldots &   \vdots  &  \ldots  &  \ldots  \\
     0  &      0  &   w_{1} &   \ldots  &  w_{m-1} &   w_{m}  \\
\end{array} \right)
$$
