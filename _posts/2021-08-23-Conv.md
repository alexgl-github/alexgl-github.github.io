...
struct ndarray
{
   ...
   */
  static const T& ndarray_at(const typename ndarray<T, N, Dims...>::type & x,
                             size_t index)
  {
  ...
  static T& ndarray_at(typename ndarray<T, N, Dims...>::type & x, size_t index)
  {
     ...
     */
    return const_cast<T&>(
        ndarray_at(static_cast<const ndarray<T, N, Dims...>::type&>(x), index));
  }
...
### Helper functions for printing N dimentional  arrays
Add weights and bias initializers similar to the eariler python implementation.
