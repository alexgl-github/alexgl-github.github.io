...
$$
J = \frac {\partial E} {\partial \hat Y} =  \left( \frac {\partial E} {\partial \hat y_{0}}, \frac {\partial E} {\partial \hat y_{1}},  \ldots \frac {\partial E} {\partial \hat y_{n-1} } \right)
$$
...
$$
\frac {\partial \hat Y} {\partial W} = \frac {\partial (W * X)} {\partial W}
$$
...
$$
\frac {\partial E (\hat Y) } {\partial W} = J T_{x}^\intercal = \left( \frac {\partial E} {\partial \hat y_{0}}, \frac {\partial E} {\partial \hat y_{1}},  \ldots, \frac {\partial E} {\partial \hat y_{n-1} } \right)  \left( \begin{array}{ccc}
x_{0}    &      0    &  \ldots &        0   \\
x_{1}    &  x_{0}    &  \ldots &        0   \\
...
$$
\frac {\partial E (\hat Y) } {\partial X} = J T_{w}^\intercal = \left( \frac {\partial E} {\partial \hat y_{1}}, \frac {\partial E} {\partial \hat y_{2}},  \ldots, \frac {\partial E} {\partial \hat y_{n} } \right)  \left( \begin{array}{ccc}
