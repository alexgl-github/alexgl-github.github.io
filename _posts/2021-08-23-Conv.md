...
$$
\frac {\partial E} {\partial \hat Y} = J = \left( \begin{array}{ccc} \partial \hat y_{0} \partial \hat y_{1}  \ldots \partial \hat y_{n-1} \end{array} \right)
$$
...
$$
\frac {\partial E} {\partial W} = J T_{x}^\intercal = \left( \begin{array}{ccc} \partial \hat y_{0} \partial \hat y_{1}  \ldots \partial \hat y_{n-1} \end{array} \right)  \left( \begin{array}{ccc}
x_{0}    &      0    &  \ldots &        0   \\
x_{1}    &  x_{0}    &  \ldots &        0   \\
...
$$
\frac {\partial E (\hat Y) } {\partial X} = J T_{w}^\intercal = \left(  \begin{array}{ccc} \partial \hat y_{0}  \partial \hat y_{1}   \ldots  \partial \hat y_{n} \end{array} \right)  \left( \begin{array}{ccc}
