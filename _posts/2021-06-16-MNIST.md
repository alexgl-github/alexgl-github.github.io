...
and 10000 imagees and labels for validation.
...
{% highlight bash %}
$ mkdir data && cd data
$ wget https://github.com/alexgl-github/alexgl-github.github.io/blob/main/mnist/t10k-images-idx3-ubyte.gz
$ wget https://github.com/alexgl-github/alexgl-github.github.io/blob/main/mnist/t10k-labels-idx1-ubyte.gz
$ wget https://github.com/alexgl-github/alexgl-github.github.io/blob/main/mnist/train-images-idx3-ubyte.gz
$ wget https://github.com/alexgl-github/alexgl-github.github.io/blob/main/mnist/train-labels-idx1-ubyte.gz
$ gunzip *
$ cd ..
{% endhighlight %}
...
$$
Precision(plane) = \frac {TP(plane)} {TP(plane) + FN(plane)} = \frac {5} {(5 + 1)} = \frac {5} {6}
$$
...
onehot labels input yhat and probabilities input y.
...
- builds a DNN consisting of two dense layers, sigmoid layer, softmax layer;
...
epoch=0/5 iteration=200/600 loss=0.85995 f1=0.77771
epoch=0/5 iteration=400/600 loss=0.61440 f1=0.83214
epoch=0/5 iteration=600/600 loss=0.50935 f1=0.85821
epoch 0/5 time/epoch=94.00000 sec; time left=0.1044 hr; avg loss=0.50935; f1=0.85821
epoch 0/5 validation loss: 0.299749  f1: 0.90644
epoch=1/5 iteration=200/600 loss=0.25271 f1=0.92431
epoch=1/5 iteration=400/600 loss=0.24544 f1=0.92641
epoch=1/5 iteration=600/600 loss=0.23553 f1=0.92966
epoch 1/5 time/epoch=93.00000 sec; time left=0.0775 hr; avg loss=0.23553; f1=0.92966
epoch 1/5 validation loss: 0.234321  f1: 0.92660
epoch=2/5 iteration=200/600 loss=0.19353 f1=0.94115
epoch=2/5 iteration=400/600 loss=0.19091 f1=0.94222
epoch=2/5 iteration=600/600 loss=0.18567 f1=0.94427
epoch 2/5 time/epoch=92.00000 sec; time left=0.0511 hr; avg loss=0.18567; f1=0.94427
epoch 2/5 validation loss: 0.203892  f1: 0.93722
epoch=3/5 iteration=200/600 loss=0.15966 f1=0.95104
epoch=3/5 iteration=400/600 loss=0.15854 f1=0.95186
epoch=3/5 iteration=600/600 loss=0.15537 f1=0.95326
epoch 3/5 time/epoch=93.00000 sec; time left=0.0258 hr; avg loss=0.15537; f1=0.95326
epoch 3/5 validation loss: 0.184529  f1: 0.94391
epoch=4/5 iteration=200/600 loss=0.13640 f1=0.95904
epoch=4/5 iteration=400/600 loss=0.13606 f1=0.95940
epoch=4/5 iteration=600/600 loss=0.13408 f1=0.96033
epoch 4/5 time/epoch=93.00000 sec; time left=0.0000 hr; avg loss=0.13408; f1=0.96033
...
At the same time accuracy F1 metric incerased from initial 0.05 
