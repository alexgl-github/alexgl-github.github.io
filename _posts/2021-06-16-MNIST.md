...
After header containing magic number and total number of images in the dataset, there are image records.
...
It is harmonic mean of precision and recall scores:
...
...
epoch 0/5 time/epoch=89.00000 sec; time left=0.1236 hr; avg loss=0.50935; f1=0.8582
validation dataset: 10000 images and 10000 labels
...
C++ implementation is at [dense7.cpp] [cpp_source_code], [mnist.h] [mnist_source_code], and [f1.h] [f1_source_code]
