...
I''l focus on C++ implementation only.  Python implementation won't be added because MNIST classification is a very popular
...
Dataset images and labels binary files have the follwing format.
